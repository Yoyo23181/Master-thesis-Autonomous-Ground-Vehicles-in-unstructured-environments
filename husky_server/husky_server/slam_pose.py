...
class SLAMvsAMCLMonitor(Node):
    def __init__(self):
        ...
        self.create_subscription(PoseWithCovarianceStamped, '/a200_0957/pose', self.slam_callback, 10)
    ...
    def save_error_data(self, errors, suffix = ""):
        ...
        filepath = f"/sharedDrive/PLOT_GRAPH/simu/{suffix}_SLAM_simulation.csv"
    ...
    def save_plot(self):
        ...
        timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
        # filepath = f"/sharedDrive/slam/husky/slam_plot/{timestamp}.png"
        filepath = f"/sharedDrive/slam/husky/slam_plot/cdf_real_noise.png"
        ...
        # Save the CDF plot
        cdf_filepath = f"/sharedDrive/slam/husky/slam_plot/real_noise.png"
        plt.tight_layout()
